...
export class Renderer {
  ...
  constructor(
    ...
    // this.geometry = new SphereGeometry(100, 100, 100)
...
function heightBy(movement: number, height: number, fullRange = 1024) {
  const a = height * 0.3
  const normalizedMovement = movement / fullRange
  const mappedMovement = normalizedMovement * a
